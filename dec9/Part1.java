            ...
            while (scan.hasNextLine()) {
                ...
                if(part1) {
                    ...
                    for (int i = arrayListList.size() - 2; i >= 0; i--) {
                        arrayListList.get(i).add(arrayListList.get(i).get(arrayListList.get(i).size() - 1) + arrayListList.get(i + 1).get(arrayListList.get(i + 1).size() - 1));
                    } 
                    sum += arrayListList.get(0).get(arrayListList.get(0).size()-1);
                }

                if(!part1) {
                    arrayListList.get(arrayListList.size() - 1).add(0,0);
                    for(int i = arrayListList.size() - 2; i>=0; i--) {
                        arrayListList.get(i).add(0, arrayListList.get(i).get(0) - arrayListList.get(i+1).get(0));
                    }
                    sum += arrayListList.get(0).get(0);
                }
